            ...
            <div class="relative isolate overflow-hidden">
                ...
                <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
                  ...
                  <ChevronRightIcon class="h-5 w-5 text-gray-500" aria-hidden="true" />
                        ...
                        <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">Write your books with the help if Ai</h1>
                        <p class="mt-6 text-lg leading-8 text-gray-300">
                            Transform your writing process with our AI-powered book writing tool, designed to help you craft compelling stories with ease.
                        </p>
